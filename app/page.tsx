        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 text-center">
          ...
          >
            ...
            >
              ...
              <motion.a
                href="https://github.com/krishn404/srcx"
                target="_blank"
      ...
      <footer className="border-t border-border bg-muted/30 py-8 sm:py-10 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-sm text-muted-foreground text-center sm:text-left">
              <span>© {new Date().getFullYear()} srcx. A neutral listing of all active opportunities.</span>
